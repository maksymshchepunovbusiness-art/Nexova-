...
export default function LightPillar({
  ...
  useEffect(() => {
    ...
    const fragmentShader = `
      ...
      void main() {
        ...
        // Alpha based on brightness — dark areas become transparent so the
        // pillar floats over any background without a black canvas behind it.
        float brightness = max(col.r, max(col.g, col.b));
        float alpha = clamp(brightness * 2.2, 0.0, 1.0);
  ...
  // Reactive prop updates (no full remount needed)
  ...
  return (
    <div
      ref={containerRef}
      className={className}
      style={{ width: '100%', height: '100%', position: 'absolute', top: 0, left: 0, mixBlendMode: mixBlendMode as React.CSSProperties['mixBlendMode'], ...style }}
    />
  );
}
